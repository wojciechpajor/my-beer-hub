    ...
    return (
        ...
        >
            ...
            <Modal.Footer className="pt-0">
                <div className="w-100">
                    <p className="pt-0 mt-0 small">Dont have account ? Create one <span
                        onClick={() => props.setModalType("Signup")} className="signupLink">here</span></p>
                    <Button className="btn btn-warning px-5 mx-auto" style={{color: "white"}}
                            onClick={(_) => props.setShowModal(false)}>Login</Button>
                </div>
            </Modal.Footer>
        </Modal>
    )
